...
Only tested on Arch Linux with hyprland 0.50.1 and above; in order to configure a dotfile, you will need [stow](https://github.com/aspiers/stow). Here are all the steps:
